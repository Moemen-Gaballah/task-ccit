(function (root, factory) {
    ...
    (function($) {
        ...
        $.formUtils = $.extend($.formUtils || {}, {
             ...
             * directory where this js resides. If you want to load
             * the modules from another directory you can use the
             * path argument.
             *
             * The js will be cached by the browser unless the module
             * name ends with .dev
             *
            ...
            loadModules: function (modules, path, callback) {
                ...
                if (path) {
                    ...
                    var findScriptPathAndLoadModules = function () {
                        var foundPath = false;
                        $('js[src*="form-validator"]').each(function () {
                    ...
                    if (!findScriptPathAndLoadModules()) {
                        $(function () {
                            ...
                            if (!hasLoadedModuleScripts) {
                                // The modules may have been inserted via a minified js
                                if (typeof callback === 'function') {
                                    callback();
                                }
                            }
